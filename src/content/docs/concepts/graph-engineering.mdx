...
四个 harness 的 subagent 机制横向对照（含 OpenClaw 的 push 事件、Hermes 的 5 工具硬禁源码），见本站[第 10 章](/patterns/10-subagents/)和[第 12 章](/patterns/12-permissions-approvals/)——那是证据库，本章是方法。
