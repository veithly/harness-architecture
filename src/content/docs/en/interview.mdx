...
## §5.5 · Group 5 · Engineering Methods (2 chapters × 6 questions = 12)

> Topics: the Loop Engineering and Graph Engineering method chapters. Not four-system comparisons — portable method: how budgets are set, what edges carry, where guardrails live. Grounded in first-hand source of mini-swe-agent / smolagents / crewAI / open-source Codex.
